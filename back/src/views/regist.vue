<template>
  <div class="regist-main">
    ...
    <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="商店地址" prop="addr">
        <el-input v-model="ruleForm2.addr" auto-complete="off"></el-input><br>
      </el-form-item>
      <el-form-item label="商店名称" prop="shopName">
        <el-input v-model="ruleForm2.shopName" auto-complete="off"></el-input><br>
      </el-form-item>
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            axios.post('/back/add',qs.stringify({
                username:this.ruleForm2.username,
                password:this.ruleForm2.pass,
                addr:this.ruleForm2.addr,
                shopName:this.ruleForm2.shopName
              }),{
                headers: {
