    ...
    <div class="sku-box store-content ">
      ...
      <div class="gray-box">
        <div style="padding-top: 10px;padding-left: 10px">
          ...
          <el-button v-if="orderType==1" type="primary" disabled>热门商品</el-button>
          <el-button v-else @click='changeOrderType(1)'>热门商品</el-button>&nbsp;&nbsp;•
          <el-button v-if="orderType==2" type="primary" disabled>价格从高到低</el-button>
          <el-button v-else @click='changeOrderType(2)'>价格从高到低</el-button>&nbsp;&nbsp;•
          <el-button v-if="orderType==3" type="primary" disabled>价格从低到高</el-button>
          <el-button v-else @click='changeOrderType(3)'>价格从低到高</el-button>
        </div>
        <div class="item-box">
          <shopItem v-for="(item,index) in goodsData" :item="item" :key="index"></shopItem>
        </div>
        <el-pagination style="text-align: center;height: 66px;"
